-- =====================================================================
-- CRIS · move_tire: defaults nos parâmetros opcionais (dual e km), para
-- os types gerados aceitarem chamadas sem eles. Mesma lógica da versão
-- anterior — create or replace.
-- =====================================================================

drop function if exists move_tire(uuid, uuid, smallint, text, text, integer);
...
create or replace function move_tire(
  ...
  p_target_side     text,
  p_target_dual     text default null,  -- null = posição simples
